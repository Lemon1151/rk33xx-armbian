...
# https://github.com/Lemon1151/kernel/releases/download/dev/armbian.tar.xz
# Include the following contents:
# ~/compile-kernel/tools/script/armbian-compile-kernel-depends
# https://github.com/Lemon1151/kernel/releases/download/dev/arm-gnu-toolchain-x.tar.xz
#
#================================== Functions list ==================================
#
...
dev_repo="https://github.com/Lemon1151/kernel/releases/download/dev"
